<template>
  ...
  <div class="content">
    <div class="left">
      ...
      <el-form-item label="分类：">
        <el-select v-model="category" class="m-2" placeholder="Select">
          <el-option
  ...
  <div class="footer">
    ...
    <div class="jio">
      <el-table :data="getGongGaoList" style="width: 100%">
...
import { useGongGao } from "../store/shopList";
...
let { getGongGaoList, swiperlist } = toRefs(GongGaoStore);
let {
  setGongGao,
  setGongGaoAdd,
  del,
...
let { name, desc, coverImage, content, link, category, price, amount } = toRefs(
  GongGaoStore.addList
);
...
let submitForm = async () => {
  ...
  setSearchGongGao(inputVal.value, category.value);
};
onBeforeMount(() => {
  setGongGao();
});
